                ...
                <div id="auth-left">
                    ...
                    <form id="registerForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control form-control-xl" placeholder="Correo Electrónico" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-xl" placeholder="Matrícula" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control form-control-xl" placeholder="Contraseña" required>
                        </div>
