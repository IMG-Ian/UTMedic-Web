...
<head>
  ...
  <link rel="stylesheet" crossorigin href="<?php echo ASSETS_URL; ?>/compiled/css/app.css">
  <link rel="stylesheet" crossorigin href="<?php echo ASSETS_URL; ?>/compiled/css/error.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/utmedic-global.css?v=<?= time() ?>">
    <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/utmedic-dashboard.css?v=<?= time() ?>">
</head>

<body>
    <script src="<?php echo ASSETS_URL; ?>/static/js/initTheme.js"></script>
    <div id="error">
...
<div class="error-page container">
    <div class="col-md-8 col-12 offset-md-2">
        <div class="text-center">
            <img class="img-error" src="<?php echo ASSETS_URL; ?>/compiled/svg/error-500.svg" alt="System Error">
            <h1 class="error-title">System Error</h1>
            <p class="fs-5 text-gray-600">The website is currently unaivailable. Try again later or contact the
                developer.</p>
            <a href="<?php echo FRONTEND_URL; ?>/index.php" class="btn btn-lg btn-outline-primary mt-3">Go Home</a>
        </div>
    </div>
</div>
