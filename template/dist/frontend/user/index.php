    ...
    <div id="app">
        ...
        <div id="main">
            ...
            <div class="page-content">
                <section class="row">
                    <!-- Left Column: Greetings & Appointments -->
                    <div class="col-12 col-lg-8">
                        ...
                        <div class="card shadow-sm border-0 mb-4"
                            style="border-radius: 1rem; background: var(--bs-card-bg); box-shadow: 0 0.5rem 1rem rgba(0,0,0,0.05);">
                            <div class="card-header bg-transparent border-0 pt-4 pb-0 text-center">
                                <h4 class="font-bold text-body">Próximas Citas</h4>
                            </div>
                    ...
                    <!-- Right Column: Calendar & Carousel -->
