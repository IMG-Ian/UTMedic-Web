    ...
    <script>
        ...
        function validarCita(event) {
            ...
            if (!dateSelect.value || !selectedTimeInput.value) {
                Swal.fire({ icon: 'warning', title: 'Horario Requerido', text: 'Por favor selecciona una fecha y un horario disponible.' });
                return false;
            }
            if (!doctorSelect.value) {
                Swal.fire({ icon: 'warning', title: 'Profesional Requerido', text: 'Por favor selecciona obligatoriamente a un Profesional.' });
                return false;
            }
            ...
            .catch(err => {
                Swal.fire({ icon: 'error', title: 'Error', text: 'Hubo un problema de conexión al agendar.' });
                btnConfirmar.innerText = 'Confirmar Cita';
                btnConfirmar.disabled = false;
            });
            return false;
